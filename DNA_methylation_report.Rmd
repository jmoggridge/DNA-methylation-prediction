...
The accuracy of the classifiers overall was quite high; with optimal tuning each of the LR, SVM, and RF models were able to reach AUC of 0.9. Similar performance was possible with logistic regression models with very weak regularization despite their proneness to overfitting. The ease with which 90% accuracy could be reached indicates that a very large proportion of the CpG sites are relatively easy to predict. Perhaps this is in part because methylation status is correlated with the nominal data relating to CpG islands, genes, and regulatory features, as well several of the dinucleotide frequencies (fig. 1).
