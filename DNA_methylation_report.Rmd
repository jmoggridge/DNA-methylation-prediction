...
The best performing models of each type were re-fit to the entire training set (~8k examples) used to predict an unseen validation set of ~24k. The logistic regression model was most successful of the bunch in terms of AUC (0.985), accuracy (0.950), recall (0.929), and F1 score (0.919). The random forest model had greater precision (0.916) than the logistic regression model
